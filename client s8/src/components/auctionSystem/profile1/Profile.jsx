...
const Profile = () => {
  ...
  // User details state (merged all fields)
            ...
            <div className="details-section">
              <div className="info">
                ...
                <p>
                  ...
                  {userDetails.buildingName || ""} {userDetails.state || ""} {userDetails.street || ""}{" "}
                  {userDetails.pincode || ""}
                </p>
              </div>
              {/* Professional Details section can be added back if needed */}
            </div>
          </div>
